...
void initialize(MatrixOur& dataset, MatrixOur& centroids, VectorOur& labels, ClusterIndexVector& clusters_point_index, ClusterIndexVector& clusters_neighbors_index,
...
void initialize(MatrixOur& dataset, MatrixOur& centroids, VectorOur& labels, ClusterIndexVector& clusters_point_index, ClusterIndexVector& clusters_neighbors_index, ClusterDistVector& point_center_dist)
{
    /*
...
{
    MatrixOur dataset = load_data("c:/users/yog/source/repos/test20/test20/data+centers/dataset/Epileptic.csv") ;
    MatrixOur centroids = load_data("c:/users/yog/source/repos/test20/test20/data+centers/centroids/Epileptic6.csv") ;
